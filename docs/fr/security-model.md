...
- Les correctifs CSS/élément réversibles de Chrome sont réservés au mode Dev et soumis à une autorisation par hôte. Les diagnostics console, réseau et écouteurs d'événements sont des lectures Dev ; leurs résultats dérivés de la page sont traités comme contenu non fiable. Les en-têtes et corps réseau sont exclus par défaut, et les en-têtes sensibles sont toujours masqués avant la mise en mémoire tampon
