...
export default {
  ...
  'st.skills.desc_html': 'Add custom skills that are appended to WebBrain\'s main system prompt. Import trusted text from a URL or paste raw instructions below. No built-in skills are enabled by default.',
  ...
  'st.skills.empty': 'No custom skills added yet.',
  'st.skills.list.heading': 'Added skills',
  'st.skills.source.raw': 'Raw text',
  'st.skills.item.chars': '{count} chars',
  'st.skills.remove': 'Remove',
  'st.skills.security_html': '<strong>Heads-up:</strong> custom skills are stored in plaintext in browser local storage and sent to your configured LLM provider as part of the system prompt. Only import URLs you trust; remote content is copied into storage at import time.',
