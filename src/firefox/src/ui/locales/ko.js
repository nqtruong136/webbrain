...
export default {
  ...
  'sp.help_html': '<strong>슬래시 명령어</strong><br><code>/help</code> — 이 목록 표시<br><code>/schedule</code> — 예약 작업 만들기<br><code>/list-schedules</code> — 예약 작업 표시<br><code>/check-progress</code> — 현재 진행 로그 표시<br><code>/show-scratchpad</code> — 현재 스크래치패드 표시<br><code>/edit-scratchpad &lt;text&gt;</code> — 현재 스크래치패드에 텍스트 추가<br><code>/clear-scratchpad</code> — 현재 스크래치패드 지우기<br><code>/remember &lt;text&gt;</code> — 사용자 기본 설정을 메모리에 저장<br><code>/show-memory</code> — 저장된 사용자 메모리 표시<br><code>/forget-memory &lt;id&gt;</code> — 저장된 메모리 삭제<br><code>/allow-api</code> — 이 대화에서 API 변경 허용<br><code>/dangerously-skip-permissions</code> — 권한 확인을 전역으로 비활성화<br><code>/compact</code> — 이 대화의 컨텍스트 압축<br><code>/verbose</code> — 상세/간결 도구 표시 전환<br><code>/reset</code> — 대화 지우기<br><code>/screenshot</code> — 현재 탭 캡처<br><code>/export</code> — 대화를 Markdown으로 다운로드<br><code>/export-with-traces</code> — 도구 체인(추적) 내보내기<br><code>/profile</code> — 프로필 자동 입력 전환<br><code>/vision</code> — 활성 제공자의 비전 모드 전환<br><code>/ask</code> — 질문 모드로 전환<br><code>/act</code> — 실행 모드로 전환<br><code>/dev</code> — 개발 모드로 전환',
