...
export default {
  ...
  "sp.help_html": "<strong>Eğik Çizgi Komutları</strong><br><code>/help</code> — Bu listeyi göster<br><code>/schedule</code> — Zamanlanmış görev oluştur<br><code>/list-schedules</code> — Zamanlanmış görevleri göster<br><code>/check-progress</code> — Geçerli ilerleme günlüğünü göster<br><code>/show-scratchpad</code> — Geçerli not defterini göster<br><code>/edit-scratchpad &lt;text&gt;</code> — Geçerli not defterine metin ekle<br><code>/clear-scratchpad</code> — Geçerli not defterini temizle<br><code>/remember &lt;text&gt;</code> — Kullanıcı tercihini belleğe kaydet<br><code>/show-memory</code> — Kaydedilmiş kullanıcı belleğini göster<br><code>/forget-memory &lt;id&gt;</code> — Kaydedilmiş bir belleği unut<br><code>/allow-api</code> — Bu konuşma için API mutasyonlarına izin ver<br><code>/dangerously-skip-permissions</code> — İzin istemlerini küresel olarak devre dışı bırak<br><code>/compact</code> — Bu konuşmanın bağlamını sıkıştır<br><code>/verbose</code> — Ayrıntılı/kompakt araç görünümünü aç/kapat<br><code>/reset</code> — Konuşmayı temizle<br><code>/screenshot</code> — Geçerli sekmenin ekran görüntüsünü al<br><code>/full-page-screenshot</code> — Sayfanın tamamını yakala (yalnızca Chrome)<br><code>/record</code> — Geçerli sekmenin kaydını başlat<br><code>/record --transcribe</code> — Kaydet ve durdurduktan sonra Whisper dökümü kaydet<br><code>/record-full-screen</code> — Ekranı veya pencereyi kaydet (yalnızca Chrome)<br><code>/record-full-screen --transcribe</code> — Ekran/pencereyi kaydet ve dökümü kaydet<br><code>/export</code> — Konuşmayı Markdown olarak indir<br><code>/export-with-traces</code> — Araç zincirini (izleri) dışa aktar<br><code>/profile</code> — Profil otomatik doldurmayı aç/kapat<br><code>/vision</code> — Aktif sağlayıcıda görme kipini aç/kapat<br><code>/ask</code> — Sor moduna geç<br><code>/act</code> — Uygula moduna geç<br><code>/dev</code> — Dev moduna geç<br><br><strong>Klavye Kısayolları</strong><br><code>Ctrl/Cmd+/</code> — Giriş alanına odaklan<br><code>Ctrl/Cmd+Shift+A</code> — Sor moduna geç<br><code>Ctrl/Cmd+Shift+X</code> — Uygula moduna geç<br><code>Ctrl/Cmd+Shift+D</code> — Dev moduna geç<br><code>Ctrl/Cmd+M</code> — Ses girişini aç/kapat",
