...
export default {
  ...
  'st.skills.desc_html': 'WebBrain ana sistem istemine eklenecek özel skill\'ler ekle. Güvendiğin bir URL\'den metin içe aktar veya ham talimatları aşağıya yapıştır. Varsayılan olarak yerleşik skill etkin değil.',
  ...
  'st.skills.empty': 'Henüz özel skill eklenmedi.',
  'st.skills.list.heading': 'Eklenen skill\'ler',
  'st.skills.source.raw': 'Ham metin',
  'st.skills.item.chars': '{count} karakter',
  'st.skills.remove': 'Kaldır',
  'st.skills.security_html': '<strong>Dikkat:</strong> özel skill\'ler tarayıcı yerel depolamasında düz metin olarak saklanır ve sistem isteminin parçası olarak yapılandırdığın LLM sağlayıcısına gönderilir. Yalnızca güvendiğin URL\'leri içe aktar; uzak içerik içe aktarma sırasında depoya kopyalanır.',
