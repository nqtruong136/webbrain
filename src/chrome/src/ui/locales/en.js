...
export default {
  ...
  'sp.btn.record': 'Record this tab',
  'sp.btn.record.active': 'Stop recording',
  'sp.record.options.title': 'Record this tab',
  'sp.record.options.video': 'Include video',
  'sp.record.options.mic': 'Include microphone',
  'sp.record.options.transcribe': 'Transcribe after recording (Whisper)',
  'sp.record.consent_reminder': 'Heads up: recording a meeting may require consent from other participants. Make sure you have it before starting.',
  'sp.record.start': 'Start',
  'sp.record.cancel': 'Cancel',
  'sp.record.stop': 'Stop',
