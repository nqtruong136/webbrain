...
export default {
  ...
  "sp.help_html": "<strong>Comandos de barra</strong><br><code>/help</code> — Muestra esta lista<br><code>/schedule</code> — Crear una tarea programada<br><code>/list-schedules</code> — Mostrar tareas programadas<br><code>/check-progress</code> — Mostrar el registro de progreso actual<br><code>/show-scratchpad</code> — Mostrar el bloc de notas actual<br><code>/edit-scratchpad &lt;text&gt;</code> — Añadir texto al bloc de notas actual<br><code>/clear-scratchpad</code> — Borrar el bloc de notas actual<br><code>/remember &lt;text&gt;</code> — Guardar una preferencia del usuario en memoria<br><code>/show-memory</code> — Mostrar la memoria del usuario guardada<br><code>/forget-memory &lt;id&gt;</code> — Olvidar una memoria guardada<br><code>/allow-api</code> — Permite mutaciones de API en esta conversación<br><code>/dangerously-skip-permissions</code> — Desactivar las solicitudes de permiso globalmente<br><code>/compact</code> — Compactar el contexto de esta conversación<br><code>/verbose</code> — Alterna entre vista de herramientas detallada/compacta<br><code>/reset</code> — Borra la conversación<br><code>/screenshot</code> — Captura la pestaña actual<br><code>/full-page-screenshot</code> — Capturar la página completa (solo Chrome)<br><code>/record</code> — Iniciar grabación de la pestaña actual<br><code>/record --transcribe</code> — Grabar y guardar una transcripción de Whisper al detener<br><code>/record-full-screen</code> — Grabar una pantalla o ventana (solo Chrome)<br><code>/record-full-screen --transcribe</code> — Grabar pantalla/ventana y guardar una transcripción<br><code>/export</code> — Descarga la conversación como Markdown<br><code>/export-with-traces</code> — Exportar la cadena de herramientas (trazas)<br><code>/profile</code> — Alterna el autocompletado del perfil<br><code>/vision</code> — Alterna el modo de visión en el proveedor activo<br><code>/ask</code> — Cambiar al modo Preguntar<br><code>/act</code> — Cambiar al modo Actuar<br><code>/dev</code> — Cambiar al modo Desarrollo<br><br><strong>Atajos de teclado</strong><br><code>Ctrl/Cmd+/</code> — Enfocar la entrada<br><code>Ctrl/Cmd+Shift+A</code> — Cambiar al modo Preguntar<br><code>Ctrl/Cmd+Shift+X</code> — Cambiar al modo Actuar<br><code>Ctrl/Cmd+Shift+D</code> — Cambiar al modo Desarrollo<br><code>Ctrl/Cmd+M</code> — Alternar entrada de voz",
